export const policies = {
    terms: `
        <h3>제1조 (목적)</h3>
        <p>이 약관은 <strong>용사 키우기</strong>(Growing hero)(이하 '본 서비스')가 제공하는 무료 교육용 웹 애플리케이션 서비스를 이용함에 있어 서비스 제공자와 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.</p>
        ...
        <p>① 회원은 본 서비스에 언제든지 탈퇴를 요청할 수 있으며, 본 서비스는 즉시 회원탈퇴를 처리합니다.</p>
        <p>② 회원이 다음 각 호의 사유에 해당하는 경우, 본 서비스는 회원자격을 제한 및 정지시킬 수 있습니다.</p>
        <ol>
            <li>가입 신청 시에 허위 내용을 등록한 경우</li>
            <li>다른 사람의 서비스 이용을 방해하거나 그 정보를 도용하는 등 서비스 운영 질서를 위협하는 경우</li>
            <li>본 서비스를 이용하여 법령 또는 이 약관이 금지하거나 공서양속에 반하는 행위를 하는 경우</li>
        </ol>
        
        <h3>제8조 (저작권의 귀속 및 이용제한)</h3>
        <p>① 본 서비스가 작성한 저작물에 대한 저작권 기타 지적재산권은 본 서비스(개발 교사)에 귀속됩니다.</p>
        <p>② 이용자는 본 서비스를 이용함으로써 얻은 정보 중 본 서비스에게 지적재산권이 귀속된 정보를 본 서비스의 사전 승낙 없이 복제, 송신, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나 제3자에게 이용하게 하여서는 안됩니다.</p>
        
        <h3>부칙</h3>
        <p>이 약관은 2026년 7월 3일부터 시행됩니다.</p>
    `,
    privacy: `
        <p><strong>용사 키우기</strong>(이하 '본 서비스')은(는) 「개인정보 보호법」 제30조에 따라 정보주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.</p>
        ...
        <p>① 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체 없이 해당 개인정보 파기를 진행합니다.</p>
        ...
        <ul>
            ...
            <li><strong>해킹 등에 대비한 기술적 대책</strong>: 보안 인증을 획득한 전문 클라우드 플랫폼(예: Vercel, Firebase 등)을 기반으로 운영되며, 전 구간 보안 통신(HTTPS)을 사용하여 데이터를 암호화하여 전송합니다.</li>
        ...
        <ul>
            <li><strong>성명</strong>: 양수빈 (개발자)</li>
            <li><strong>소속</strong>: 서울수리초등학교</li>
            <li><strong>직위</strong>: 교사</li>
            <li><strong>연락처</strong>: 02-353-9400 (학교 교무실 내선 번호) <br><em>(※ 개인정보보호를 위해 교사의 개인 휴대전화 번호는 기재하지 않습니다.)</em></li>
        </ul>

        <h3>제9조 (개인정보 처리방침 변경)</h3>
        <p>이 개인정보 처리방침은 2026년 7월 3일부터 적용됩니다.</p>
    `
};
